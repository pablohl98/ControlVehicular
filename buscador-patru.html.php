...
<head>
	...
	<script type="text/javascript" src='actualiza-patrulla.js'> </script>
...
<header>
	...
	<h2>Actualizar datos de Patrulla</h2>
</header>
<body>
<?php
		$id = ""; 
		...
		if ($query_run->num_rows==0) {
			echo '<script type="text/javascript">sweetAlert("Patrulla no encontrada","Número de patrulla incorrecto","error")</script>';
			$id= $nulo;
			$nombre = $nulo;
			$marca = $nulo;
			$modelo =  $nulo;  
